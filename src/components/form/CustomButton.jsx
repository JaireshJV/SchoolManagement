...
const primaryButtonStyles = css`
  background: ${THEME.primary_2} !important;
  color: #fff;
...
const yellowButtonStyles = css`
  ...
  &:focus {
    box-shadow: 0 0 0 0.2rem (255, 179, 2, 0.5);
  }
`;
...
const PlainButton = styled(AntdButton)`
  ...
  ${(props) => props.type === "white" && whiteButtonStyles};
  ${(props) => props.type === "GoBack" && goBackButtonStyles};
  ${(props) => props.type === "Add" && AddButtonStyles};
...
const Success = ({ text, style, icon, ...props }) => (
...
const Default = ({ icon, text, style, onClick, ...rest }) => {
  return (
    <PlainButton style={style} onClick={onClick} {...rest} type="default">
      {icon}
      <TextContainer icon={icon ? "true" : "false"}>{text}</TextContainer>
    </PlainButton>
  );
...
const White = ({ icon, text, onClick, ...rest }) => {
  return (
    <PlainButton onClick={onClick} {...rest} type="white">
      {icon}
      <TextContainer icon={icon ? "true" : "false"}>{text}</TextContainer>
    </PlainButton>
  );
...
const GoBack = ({ icon, text, onClick, ...rest }) => {
  return (
    <PlainButton onClick={onClick} {...rest} type="GoBack">
      {icon}
      <TextContainer icon={icon ? "true" : "false"}>{text}</TextContainer>
    </PlainButton>
  );
...
const Add = ({ icon, text, onClick, ...rest }) => {
  return (
    <PlainButton onClick={onClick} {...rest} type="Add">
      {icon}
      <TextContainer icon={icon ? "true" : "false"}>{text}</TextContainer>
    </PlainButton>
  );
