...
export const logisticsItems = (collapsed) => {
  ...
  const items = [
    ...
    getItem("Report", "sub4", <TbReportAnalytics />, [
    ...
    getItem("Quotation", "sub5", <MdRequestQuote />, [
...
export const logisticskeys = ["sub1", "sub2", "sub3", "sub4", "sub5", "sub6", "sub7", "sub8", "sub9"];